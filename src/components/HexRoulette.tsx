...
const funFacts = [
    ...
    { hex: "0x1A", text: "The Computer is incredibly fast, accurate and stupid. Human is unbelievably slow, inaccurate and brilliant. The marriage of the two is a challenge and an opportunity beyond imagination. — Advances in Instrumentation, 1969" },
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        ...(isTooltip ? {
                            ...
                            padding: "1rem",
                            borderRadius: "10px",
                            border: "1px solid hsla(225, 25%, 55%, 0.3)",
                            boxShadow: "none",
                            zIndex: 100,
                            width: "max-content",
                            minWidth: "200px",
